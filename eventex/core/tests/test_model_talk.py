...
class PeriodManagerTest(TestCase):
    def setUp(self):
        Talk.objects.create(title='Talk morning', start='11:59')
        Talk.objects.create(title='Talk afternoon', start='12:00')
...
class CourseModelTest(TestCase):
    def setUp(self):
        self.course = Course.objects.create(title='Titulo do Curso', start='09:00', description='Descrição do Curso', slots=20)

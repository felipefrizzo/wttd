...
class TemplataRegressionTest(TestCase):
    def test_template_has_non_field_errors(self):
        invalid_data = dict(name='Felipe Frizzo', cpf='12345678901')
        response = self.client.post(r_url('subscriptions:new'), invalid_data)
